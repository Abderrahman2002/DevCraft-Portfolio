  ...
  const contactInfo = [
    {
      icon: <Mail size={24} />,
      title: 'Email',
      content: 'abdearahmanbolman@gmail.com',
      link: 'mailto:abdearahmanbolman@gmail.com',
    },
    {
      icon: <Phone size={24} />,
      title: 'Phone',
      content: '+212 628526297',
      link: 'tel:+212 628526297',
    },
    {
      icon: <MapPin size={24} />,
      title: 'Location',
      content: 'AGADIR ,SOUSS MASSA, Morocco',
            ...
            >
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a 
                    href="https://github.com/Abderrahman2002"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a 
                    href="https://www.linkedin.com/in/abderrahman-boulmane-427b91245/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:bg-primary-100 dark:hover:bg-primary-900/30 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200"
                  >
                  ...
                  <a 
                    href="https://www.facebook.com/abdearahman.bolman.1?locale=ar_AR"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:bg-primary-100 dark:hover:bg-primary-900/30 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200"
                  >
                  ...
                  <a 
                    href="https://www.instagram.com/abderrahman_boulmane/?hl=ar"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:bg-primary-100 dark:hover:bg-primary-900/30 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200"
                  >
